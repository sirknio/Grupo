...
<?php if ($print <> '') { echo "<hr><pre>";print_r($print);echo"<hr>";echo "</pre><hr>"; } ?>
	...
	<header class="w3-container" style="padding-top:22px">
		<?php if (! $update) : ?>
			<h5><b><i class="fa fa-dashboard"></i>  Creaci&oacute;n Usuarios</b></h5>
		<?php else: ?>
			<h5><b><i class="fa fa-dashboard"></i>  Modificaci&oacute;n Usuarios</b></h5>
		<?php endif; ?>
	</header>
	...
	<?= "<br>";?>
	<?php if (! $update) : ?>
	<?= form_open_multipart('Usuario/crearUsuario');?>
	<?php else : ?>
	<?= form_open_multipart('Usuario/actualizarUsuario/'.set_value('idUsuario'));?>
	<?php endif; ?>
		<table>
			<tr>
				<td>  Usuario:&nbsp;&nbsp;&nbsp;</td>
			...
			<tr>
				<td colspan="2" align=center>
					...
					<?php endif; ?>
					<button type="button" class="w3-btn" onClick="window.location='<?=base_url('usuario')?>'">&nbsp;Cancelar&nbsp;&nbsp;&nbsp;<i class="fa fa-sign-out"></i>&nbsp;</button>
				</td>
		   </tr>      
		</table>
	</form>
